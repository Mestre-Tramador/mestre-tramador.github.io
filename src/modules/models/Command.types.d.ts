...
/**
 * A Command Handler is a specific method to get `string`
 * inputs and attempt to execute a command on it.
 */
type CommandHandler = (input: string) => Promise<CommandInputResult>;
